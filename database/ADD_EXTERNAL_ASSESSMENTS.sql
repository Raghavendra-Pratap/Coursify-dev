-- Assessment Pro integration: external assessments, sessions, responses, webhook idempotency.
-- Run in Supabase SQL Editor after schema.sql.

-- Allow assessment content type
...
-- external_assessments: links content item to Assessment Pro assessment
...
-- external_assessments: readable when content item is accessible
...
-- Sessions: learners see own; instructors see course learners
...
-- Responses: same access as parent session
...
-- Webhook events: service role only (no client policies)
